...
def run():
    ...
    env_config_file = '/root/catkin_stage/src/stage-ros-oa/CrowdNav/crowd_nav/data/output/env.config'             #path beginging without slash
    policy_config_file = '/root/catkin_stage/src/stage-ros-oa/CrowdNav/crowd_nav/data/output/policy.config'
    model_weights = '/root/catkin_stage/src/stage-ros-oa/CrowdNav/rl_model.pth'
    # print(model_weights)
    # select policy
